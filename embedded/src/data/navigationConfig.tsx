...
export const navSections: Record<SectionKey, NavSection> = {
  ...
  'sensor-setting': {
    ...
    items: [
      { key: 'device-list', label: 'Sensor', path: '/devices', icon: <UnorderedListOutlined /> },
      { key: 'model-setting', label: 'Model', path: '/devices/models', icon: <BlockOutlined /> },
      { key: 'parameter-setting', label: 'Parameter', path: '/devices/parameters', icon: <FormOutlined /> },
